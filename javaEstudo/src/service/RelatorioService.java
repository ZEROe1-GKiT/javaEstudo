...
public class RelatorioService implements Serializable {
	...
	public String gerarRelatorio(List<?> listaDataBeanColletion,
		...
		JRBeanCollectionDataSource jrbcd = new JRBeanCollectionDataSource(
				listaDataBeanColletion);
		...
		if (caminhoRelatorio == null
				|| (caminhoRelatorio != null && caminhoRelatorio.isEmpty() || !file
						.exists())) {
		...
		JasperPrint impressoraJasper = JasperFillManager.fillReport(
				relatorioJasper, parametrosRelatorio, jrbcd);
